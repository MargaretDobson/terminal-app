...
class BusyBee < FitnessProgram
    ...
    def suggested_plan(bmi)
        ...
        if (bmi <= 25)
            ...
            have access to our gym during Friday evening or all day during weekend"
        else
